...
('entity-reservation', 'entity', 'Reservation',
 ...
 'active',
 json_object('source','seed','confidence',0.95,'source_ref','app/models.py:18'),
 datetime('now'), datetime('now')),
('entity-resource', 'entity', 'Resource',
 'Bookable resource (room, equipment). is_active flag gates new bookings.',
 'active',
 json_object('source','seed','confidence',0.95,'source_ref','app/models.py:11'),
 datetime('now'), datetime('now'));
...
('cap-cancel-reservation', 'capability', 'Cancel a Reservation',
 ...
 'active',
 json_object('source','seed','confidence',0.9,'source_ref','app/services.py'),
 datetime('now'), datetime('now')),
...
('flow-user-cancel', 'flow', 'User cancels own reservation',
 ...
 'active',
 json_object('source','seed','confidence',0.95,'source_ref','app/services.py:42'),
 datetime('now'), datetime('now')),
...
('flow-admin-force-cancel', 'flow', 'Admin force-cancels a reservation',
 ...
 'active',
 json_object('source','seed','confidence',0.95,'source_ref','app/services.py:55'),
 datetime('now'), datetime('now')),
...
('flow-resource-deactivation-cascade', 'flow', 'Resource deactivation cascades to active reservations',
 ...
 'active',
 json_object('source','seed','confidence',0.9,'source_ref','app/services.py:64'),
 datetime('now'), datetime('now')),
...
('flow-pending-ttl-expire', 'flow', 'Background job expires stale PENDING reservations',
 ...
 'active',
 json_object('source','seed','confidence',0.9,'source_ref','scripts/expire_pending.py:13'),
 datetime('now'), datetime('now'));
...
('rule-cancellation-window', 'rule', 'User cancellation requires >=2h before start',
 ...
 'active',
 json_object('source','seed','confidence',0.95,'source_ref','app/rules.py:10'),
 datetime('now'), datetime('now')),
...
('rule-pending-ttl', 'rule', 'PENDING reservations expire after 15 minutes',
 ...
 'active',
 json_object('source','seed','confidence',0.95,'source_ref','app/rules.py:17'),
 datetime('now'), datetime('now')),
...
('rule-no-overlap', 'rule', 'Resource cannot be double-booked',
 ...
 'active',
 json_object('source','seed','confidence',0.95,'source_ref','app/services.py:18'),
 datetime('now'), datetime('now'));
...
('module-services', 'module', 'app/services.py',
 ...
 'active',
 json_object('source','seed','confidence',1.0,'source_ref','app/services.py'),
 datetime('now'), datetime('now')),
('module-api', 'module', 'app/api.py',
 'FastAPI endpoints. Thin layer over services.',
 'active',
 json_object('source','seed','confidence',1.0,'source_ref','app/api.py'),
 datetime('now'), datetime('now'));
